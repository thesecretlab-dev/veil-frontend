...
import shaderSource from "@/shaders/veil-blobs.wgsl"

function startWebglFallback(canvas: HTMLCanvasElement) {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        ...
        if (!disposed) stopFallback = startWebglFallback(canvas)
      }
    })()
