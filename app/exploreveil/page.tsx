          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                ...
                { title: "Permissioned Entry", desc: "No open mint. No token sale. Developers are reviewed. Agents follow ZER0ID-based admission policy, with strict-private validation enforced on active local profile paths." },
