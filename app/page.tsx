...
export default function ShaderShowcase() {
  ...
  return (
    <div className="relative w-full min-h-screen veil-custom-cursor">
      <SmoothScroll />
      <VeilCursor />
      <FilmGrain />
      ...
      <div className="fixed top-8 left-8 pointer-events-auto z-50 flex items-center gap-4">
        <Magnetic strength={0.25} radius={80}>
          <Link href="/lab" className="flex items-center gap-1.5 group/tsl" style={{ transition: "all 1.5s ease" }}>
            ...
            <span style={{
              fontSize: "9px", letterSpacing: "0.2em", color: "rgba(255,255,255,0.26)",
              fontFamily: "var(--font-space-grotesk)", transition: "color 1.5s ease",
            }} className="group-hover/tsl:!text-white/15">tsl</span>
          </Link>
        </Magnetic>
        <span style={{ color: "rgba(255,255,255,0.24)", fontSize: "10px" }}>/</span>
        <Magnetic strength={0.25} radius={80}>
          <div className="flex items-center gap-2.5">
            <TriangleLogo />
            <span style={{
              fontSize: "13px", letterSpacing: "0.25em", color: "rgba(255,255,255,0.30)",
              fontFamily: "var(--font-space-grotesk)", fontWeight: 600,
              textShadow: "0 0 10px rgba(16,185,129,0.08)", transition: "all 1.5s ease",
            }}>VEIL</span>
          </div>
        </Magnetic>
      </div>
      ...
      <motion.div className="relative z-10 flex flex-col items-center justify-center min-h-screen group veil-adaptive-text"
        ...
        <motion.h1
          ...
          style={{
            ...
            textShadow: "0 0 15px rgba(16,185,129,0.2), 0 0 30px rgba(16,185,129,0.1), 0 0 60px rgba(16,185,129,0.05)",
            WebkitTextStroke: "1px rgba(16,185,129,0.12)",
